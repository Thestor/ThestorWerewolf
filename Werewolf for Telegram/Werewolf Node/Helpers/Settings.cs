...
namespace Werewolf_Node
{
    static class Settings
    {
	    ...
	    PlayerCountTerrorist = 10,
	    PlayerCountDarkOwl = 10,
	    ...
	    AgentConversionChance = 60,
	    TerroristConversionChance = 80,
	    AssassinConversionChance = 40,
	    DarkOwlConversionChance = 0,
