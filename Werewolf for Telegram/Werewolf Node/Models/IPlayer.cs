...
namespace Werewolf_Node.Models
{
    ...
    {
        None, Lynch, Eat, Shoot, VisitWolf, VisitVictim, GuardWolf, Detected, Flee, Hunt, HunterShot, LoverDied, AssassinGuilty, SerialKilled, HunterCult, GuardKiller, VisitKiller, ChainKilled, BombKilled, BombSuicide, AssassinKilled, AssassinMistake, AssassinCult, Idle, TRSuicide, Suicide
    }
}
